 ...
 * @version 1.0.0
 */
public class PxExcelBuilderTest {

    @Test
    public void test() throws IOException, IntrospectionException, InvocationTargetException, IllegalAccessException {
        ...
        PxDynamicHeadExcel<BeanA> px = PxExcelBuilder.builder().buildHSSFWb().pxDynamic(BeanA.class);
